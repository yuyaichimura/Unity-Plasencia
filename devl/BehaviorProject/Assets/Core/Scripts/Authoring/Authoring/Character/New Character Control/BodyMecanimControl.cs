...
/// </summary>
public class BodyMecanimControl : MonoBehaviour
{
    /// <summary>
    ...
    void Update()
    {
       ...
       // Debug.Log("Hand weight:" + animator.GetLayerWeight(1));
    ...
    public void SetResetHandAnimation(bool val)
    {
        resettingHandLayerWeight = val;
    }
}
