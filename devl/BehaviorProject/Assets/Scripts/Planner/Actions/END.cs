...
public class END : Action {
	...
	public override List<Condition> Preconditions
	{
		...
		{ 
			...
			preconditions.Add(new Condition(0, "ConflictResolved", true));
			preconditions.Add(new Condition(1, "ConflictResolved", true));
	...
	public override List<Condition> Effects
	{
		...
		{ 
			...
			effects.Add(new Condition(0, "Finished", true));
			effects.Add(new Condition(1, "Finished", true));
			return effects;
		}
	}
