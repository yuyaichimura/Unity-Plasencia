...
public class PartWays : Action {
	...
	public override void Execute ()
	{
		...
		Debug.Log (char1.name + " and " + char2.name + " mutually part ways.");
	...
	public override List<Condition> Preconditions
	{
		...
		{ 
			...
			preconditions.Add(new Condition(0, "HatesOther", true));
			preconditions.Add(new Condition(1, "HatesOther", true));
			/*
			preconditions.Add(new Condition(0, "Murderous", false));
			preconditions.Add(new Condition(1, "Murderous", false));
			preconditions.Add(new Condition(0, "Suicidal", false));
			preconditions.Add(new Condition(1, "Suicidal", false));*/
